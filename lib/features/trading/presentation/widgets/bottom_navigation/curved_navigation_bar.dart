...
import 'package:trading_app/features/trading/presentation/widgets/bottom_navigation/curved_navigation_bar_item.dart';
...
class CurvedNavigationBar extends StatefulWidget {
  ...
  /// Gradient for [CurvedNavigationBar] background shape.
  ...
  void initState() {
    ...
    _animationController.addListener(() {
      setState(() {
        ...
        final totalDistance = (endingPos - _startingPos).abs();
                    ...
                    Positioned(
                      ...
                      child: Center(
                        child: Transform.translate(
                          offset: Offset(0, (_buttonHide - 1) * 56),
                          child: Material(
